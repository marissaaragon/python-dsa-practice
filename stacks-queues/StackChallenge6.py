...
# stack1 and stack2 is empty. In order to add an element to the back of the queue,
# you need to first transfer all elements from stack1 to stack2 using a loop that pops each element from stack1
